...
class SortEvenTest {
    ...
    void shouldNotChangeListWhenAllNumbersAreOdd() {
        ...
        List<Bus> buses = new ArrayList<>(List.of(
                Bus.builder().setNumber("7").setModel("A").setMileage(100).build(),
                Bus.builder().setNumber("5").setModel("B").setMileage(200).build(),
                Bus.builder().setNumber("3").setModel("C").setMileage(300).build(),
                Bus.builder().setNumber("1").setModel("D").setMileage(400).build()
        ));
